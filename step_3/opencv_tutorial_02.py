...
# Erosions and dilations can also be used to remove noise // Erozyonlar ve genişlemeler de gürültüyü gidermek için kullanılabilir.
# Ön plan nesnelerinin boyutunu küçültmek için, birkaç yineleme verildiğinde pikselleri aşındırabiliriz:

# we apply erosions to reduce the size of foreground objects // ön plandaki nesnelerin boyutunu küçültmek için aşındırmalar uyguluyoruz
mask = thresh.copy()
